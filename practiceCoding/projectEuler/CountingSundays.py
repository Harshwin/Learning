...
#getting 1 sunday extra in every leap year which is divisible by 400
noOfLeapYearsDivisibleBy400_1000 = [0 for i in range(3000,3000+1) if (i%400==0 and i%1000 == 0)].__len__()
print(countNumberOfStartingSundays(3000,1,1,3000,12,31) - noOfLeapYearsDivisibleBy400_1000 )
